...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'bookmarks_tag_bookmarks')
        ...
        db.create_unique(m2m_table_name, ['tag_id', 'bookmark_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'bookmarks_tag_bookmarks'))
